class ExternalLiningBookTopComponent:
    ...
    def draw(self, dwg, x_offset, y_offset):
        # External lining is a polygon with angled corners
        points = [
            ...
            (self.right_outer_x + x_offset, self.bottom_panel_end_y - 10 + y_offset),
            (self.right_inner_x - 10 + x_offset, self.bottom_outer_y + y_offset),
            (self.left_inner_x + 10 + x_offset, self.bottom_outer_y + y_offset),
            (self.left_outer_x + x_offset, self.bottom_panel_end_y - 10 + y_offset),
            (self.left_outer_x + x_offset, self.top_inner_y + 10 + y_offset)
        ]
