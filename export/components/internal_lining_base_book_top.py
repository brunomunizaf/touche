...
class InternalLiningBaseForBookTopComponent:
    ...
    def draw(self, dwg, x_offset, y_offset):
        ...
        path.push("L", 
                  ...
                  main_left_x, flap_bottom_y - clearance,
                  main_right_x, flap_bottom_y - clearance, 
        ...
        path.push("L", 
                  ...
                  flap_left_x - clearance, main_bottom_y - t,
                  flap_left_x - clearance, main_top_y + t, 
        ...
        path.push("L", 
                  ...
                  flap_right_x + clearance, main_bottom_y - t,
                  flap_right_x + clearance, main_top_y + t, 
