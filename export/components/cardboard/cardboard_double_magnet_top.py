class CardboardDoubleMagnetTopComponent:
    ...
    def _compute_size(self):
        ...
        self.raio_do_ima = 7
        self.largura_do_retangulo = self.largura + self.folga
        self.largura_total = self.largura_do_retangulo
        self.altura_total = (
            (self.profundidade - 5) + self.espacamento + self.altura + self.espacamento + self.profundidade + self.espacamento + self.altura + 7
        )
    ...
    def draw(self, dwg, x_offset, y_offset):
        ...
        coordenada_superior_primeiro_retangulo = coordenada_inferior_primeiro_retangulo + self.altura + 7

        coordenada_inferior_segundo_retangulo = coordenada_superior_primeiro_retangulo + self.espacamento
        coordenada_superior_segundo_retangulo = coordenada_inferior_segundo_retangulo + self.profundidade

        coordenada_inferior_terceiro_retangulo = coordenada_superior_segundo_retangulo + self.espacamento
        coordenada_superior_terceiro_retangulo = coordenada_inferior_terceiro_retangulo + self.altura

        coordenada_inferior_quarto_retangulo = coordenada_superior_terceiro_retangulo + self.espacamento
        coordenada_superior_quarto_retangulo = coordenada_inferior_quarto_retangulo + self.profundidade - 5

        # Desenha quatro retângulos empilhados verticalmente
        for coordenada_superior, coordenada_inferior in [
            ...
            (coordenada_inferior_quarto_retangulo, coordenada_superior_quarto_retangulo)
        ]:
        ...
        if largura + self.folga > 100:
            ...
            yM = coordenada_superior_quarto_retangulo - 30 if self.profundidade >= 100 else coordenada_superior_quarto_retangulo - (self.profundidade - 5) / 2
            ...
            yM = coordenada_superior_quarto_retangulo - (self.profundidade - 5) / 2
